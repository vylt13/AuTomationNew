...
public class TC03_VBDEN_LDChoYKien extends ThuocTinhVBDen {
	WebDriver driver;
@Test
public void TGDTrinhLanhDao() throws InterruptedException, EncryptedDocumentException, IOException {
	...
	String trich_yeu = "[VTTest]- Lãnh đạo cho ý kiến văn bản đến lúc " + createdTime; 
	...
	formXuLyVanBanDen.ChoYKienVBDen();
	formXuLyVanBanDen.waitingForLoading();
	danhSachViecCanXuLy.ValidateTaskChoYKienVBDen(
			trich_yeu, 
			co_quan_gui);
	...
	formXuLyVanBanDen.waitingForLoading();
	login.LogReport();
//	formXuLyVanBanDen.ValidateYKienLanhDao(y_kien_lanh_dao_choykien);

...
By cBoxNVPhoiHopBy = By.id("chbReport293_790");
...
public void ValidatePermissionXuLy() {
	assertEquals(driver.findElement(btnPhanCong).isEnabled(), true);
	assertEquals(driver.findElement(btnKetThuc).isEnabled(), true);
	assertEquals(driver.findElement(btnLapHSDT).isEnabled(), true);
	assertEquals(driver.findElement(btnLapHSXL).isEnabled(), true);
	assertEquals(driver.findElement(btnLuu).isEnabled(), true);

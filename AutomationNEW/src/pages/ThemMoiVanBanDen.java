...
//Select Sổ văn bản o Fom VB Den
By chonsovb = By.xpath("//div[@class='ItemInput']//select[contains (@id, 'ddlSoVBDen')]");
...
public void inputVanBanDen(
		...
		String so_ban,
		String so_trang,
		String lanh_dao) throws InterruptedException {
//  Chon Sổ Văn bản
	Select SoVanban= new Select(driver.findElement(chonsovb));
	SoVanban.selectByVisibleText(sovb);
	Thread.sleep(700);
// Nhap So Van ban

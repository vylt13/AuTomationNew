...
By btnChoYKien = By.xpath("//div[@class='Buttons']//input[contains (@id, 'btnChoYKien')]");
...
By btnHSCN = By.xpath("//div[@class='Buttons']//input[contains (@id, 'btnHoSoCaNhan')]");
...
public void CheckPhanCongPBPhoiHop() throws InterruptedException {
	WebDriverWait wait = new WebDriverWait(driver, 90);
	wait.until(ExpectedConditions.elementToBeClickable(cBoxPhanCong));
	driver.findElement(cBoxPhanCong).click();
	Thread.sleep(1000);
	WebElement donvi = driver.findElement(By.xpath("//input[contains(@data-title,'Upgrade')]"));
	String idDepartment = "chbRootDeptReport"+donvi.getAttribute("data-did");
	driver.findElement(By.id(idDepartment)).click();
}
public void CheckPhanCongDV() throws InterruptedException {
	WebDriverWait wait = new WebDriverWait(driver, 90);
	wait.until(ExpectedConditions.elementToBeClickable(cBoxPhanCong));
	driver.findElement(cBoxPhanCong).click();
	Thread.sleep(1000);
//	WebElement donvi = driver.findElement(By.xpath("//span[contains(text(),'Đức Giang')]"));
//	String idDepartment = "chbDept"+donvi.getAttribute("data-did");
//	driver.findElement(By.id(idDepartment)).click();
	driver.findElement(By.xpath("(//*[@id=\"chbDept\"][@data-did='235']")).click();
}
...
public void ValidateTatCaDonViToChucThucHien(String nguoi_chuyen) {
	assertEquals(driver.findElement(lbDonViDauTien).getText(), "Đơn vị Upgrade");
...
public void ChoYKienVBDen() {
	driver.findElement(btnChoYKien).click();	
}
public void ThemHSDT	(
		) throws InterruptedException {
	driver.findElement(btnHSCN).click();
	WebDriverWait wait = new WebDriverWait(driver, 90);
	wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(3));
	driver.findElement(By.xpath("//input[@id='btnAdd']")).click();
	driver.switchTo().defaultContent();
	driver.switchTo().frame(5);
	driver.findElement(By.xpath("//div[@class='ItemInput Title']//input[contains (@id, 'Field_Title')]")).sendKeys("hồ sơ 2");
	driver.findElement(By.xpath("//div[@class='ItemInput Description']//textarea[contains (@id, 'Field_Description')]")).sendKeys("hồ sơ 1- nội dung");
	...
	driver.switchTo().frame(3);
	 driver.findElement(By.xpath("//input[@value='Lưu vào hồ sơ']")).click();
	 Thread.sleep(3000);
//	 //Xem hồ sơ sau khi lưu
//	 driver.findElement(By.xpath("//input[@id='btnView']")).click();
//		driver.switchTo().defaultContent();
//		driver.switchTo().frame(5);
//	 assertEquals(driver.findElement(By.xpath("//*[@id=\"DynamicManageVB\"]/div[2]/span")).getText(), "1 - 1 của 1 mục");
	 //Xóa vb
//		driver.findElement(By.xpath("//*[@id=\"chkAllVB\"]")).click();
//	driver.findElement(By.xpath("//input[@id='btnDeleteDynamicGridDynamicManageVB']")).click();
...
public void ASSCheckPhanCongPB() throws InterruptedException {
	WebDriverWait wait = new WebDriverWait(driver, 90);
	WebElement donvi = driver.findElement(By.xpath("//input[contains(@data-title,'Upgrade')]"));
	String idDepartment = "chbRootDeptHandle"+donvi.getAttribute("data-did");
	driver.findElement(By.id(idDepartment)).click();

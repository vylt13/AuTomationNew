...
public void ChonDonViPhatHanh() {
	driver.findElement(By.xpath("//span[contains(.,'Tập đoàn')]")).click();
...
public void ValidateHoanTatTaskThucHienVanBanDi(
	...
	assertEquals(driver.findElement(By.xpath("//td[@class='cls-col-01']")).getText(), phong_ban_thuc_hien_vb);
	assertEquals(driver.findElement(By.xpath("//td[@class='cls-col-05 ']")).getText(), "Hoàn tất");
}
public void ValidateDangThucHienTaskVanBanDi(
	...
	assertEquals(driver.findElement(By.xpath("//div[@class='ykienlanhdao']//div[@class='noidung']")).getText(), y_kien_lanh_dao_phan_cong_vb);
	assertEquals(driver.findElement(By.xpath("//td[@class='cls-col-01']")).getText(), phong_ban_thuc_hien_vb);
	assertEquals(driver.findElement(By.xpath("//td[@class='cls-col-05 ']")).getText(), "Đang thực hiện");
}
public void ChiaseVBBH(String user_duoc_chia_se_vb,

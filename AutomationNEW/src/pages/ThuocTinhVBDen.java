...
public class ThuocTinhVBDen {
	...
	public String sovb = "Sổ VB đến Upgrade";
	...
	public String co_quan_gui = "Cơ quan ngang bộ";
	...
	public String lanh_dao_chu_tich = "Eoff Chủ tịch";
	public String account_lanh_dao_chu_tich = "Eoff Chủ tịch";
	public String nguoi_duoc_chia_se_vb_den = "eoff.sb.cv2";
	public String don_vi_phan_cong ="DUG - Don vi Upgrade - Manager";
	public String don_vi ="Đơn vị Upgrade";
